...
public class GlideCacheUtil {
    ...
    private static GlideCacheUtil in;

    public static GlideCacheUtil getInstance(){
        if (in == null)
            in = new GlideCacheUtil();
     ...
     * @param ct
     */
    public void clearImageDiskCache(final Context ct){
        ...
        }else GlideApp.get(ct).clearDiskCache();
    }
    /**
     * 清除图片内存缓存
     */
