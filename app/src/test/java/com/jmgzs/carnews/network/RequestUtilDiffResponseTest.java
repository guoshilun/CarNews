...
public class RequestUtilDiffResponseTest {
    ...
    private void testGet(){
        ...
        RequestUtil.requestByGetSync(activity, url, false, null, new IRequestCallBack<TestBean>() {
            @Override
            public Class<TestBean> getType() {
    ...
    private void testPost(){
        ...
        final Activity activity = activityController.get();
        activityController.resume();
        RequestUtil.requestByPostSync(activity, url, false, "test body", new IRequestCallBack<TestBean>() {
            @Override
            public Class<TestBean> getType() {
                return TestBean.class;
            }
